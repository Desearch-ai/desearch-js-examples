...
/**
 * Perform a Retweets for Post search using the Desearch client.
 *
 ...
 */
async function performRetweetsForPostSearch() {
    try {
        // Perform the Twitter search
        const retweetsForPost = await desearch.retweetsForPost({
