...
/**
 * Perform a Latest Tweets search using the Desearch client.
 *
 ...
 */
async function performLatestTweetsSearch() {
    try {
        // Perform the Latest Tweets search
        const latestTweets = await desearch.latestTweets({
            user: "elonmusk",
            count: 10
        });
        ...
        console.error('Error performing Latest Tweets search:', error);
    }
}

// Call the function to perform the basic Twitter search
performLatestTweetsSearch();